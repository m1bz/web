...
const config = {
    server: {
        ...
        baseUrl: process.env.BASE_URL || 'https://web-04ha.onrender.com'
    },
    ...
    database: {
        ...
        connectionString: process.env.DATABASE_URL || 'postgresql://web_r0ow_user:hgzaoOogVOQZdnayxM3nxYEmOpwUYbIs@dpg-d1de88buibrs73flusf0-a.oregon-postgres.render.com:5432/web_r0ow'
    },
